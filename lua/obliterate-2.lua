--[[
  ...
  KEYS[1] = meta
  KEYS[2] = base key ("bull:queue:")

  ARGV[1] = count (max jobs to remove per call)
  ARGV[2] = force ("force" or empty string)

  Returns:
    -1 = not paused
    -2 = has active jobs and not forced
     1 = more jobs remain, call again
     0 = fully obliterated
...
--@include "removeListJobs"
--@include "removeZSetJobs"
